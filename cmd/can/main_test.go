...
func TestLoadConfig(t *testing.T) {
	...
	tests := []struct {
		configFile     string
		expectedConfig openapi.Config
		expectedErr    bool
	}{
		{configFile: "", expectedConfig: openapi.Config{}, expectedErr: true},
		{configFile: "test_fixtures/example.yaml", expectedConfig: openapi.Config{
